(function(win,$){
    ...
    $(win).on("resize",function(){
        ...
        }else if(w_size<deviceSize.pc && w_size>= deviceSize.table && !$("html").hasClass("table")){
    ...
    $(document).on("mouseover focus",
        ".pc #gnb>ul>li>a, .table #gnb>ul>li>a",
        gnbPlay);

    $(document).on("click",
        ".moibile #gnb>ul>li:not(.no-sub)>a",
        gnbPlay);
